...
def parse_config():
    ...
    parser.add_argument('-le',       '--last_epoch'       , default=48,                                                   help='last epoch, must load epoch model')
    ...
    parser.add_argument('-il',       '--init_logs'        , default=True,                                               help='Decide if training logs are saved after each batch/epoch')
    #training config
